...
public class HomeScreenActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_drawer_linear4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				Toast.makeText(HomeScreenActivity.this, "Logout successfully", Toast.LENGTH_SHORT).show();
	...
	private void initializeLogic() {
		...
		_click_effect(_drawer_linear5, "#9E9E9E");
		_click_effect(_drawer_linear7, "#9E9E9E");
	}
	...
	public void _showDialog_version_number() {
		cust = new AlertDialog.Builder(HomeScreenActivity.this).create();
		LayoutInflater custLI = this.getLayoutInflater();
		...
		cust.setCancelable(true);
		cust.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
		text.setText(AppVersionUtil.getAppVersionName(HomeScreenActivity.this));
		cust.show();
	}
